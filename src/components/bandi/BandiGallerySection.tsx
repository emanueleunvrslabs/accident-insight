...
const BandoCard = ({ bando, index }: { bando: typeof bandi[0]; index: number }) => {
  return (
    ...
    >
      <div className="liquid-glass relative h-full rounded-2xl p-6 flex flex-col overflow-hidden transition-all duration-500 ease-out group-hover:-translate-y-0.5">
